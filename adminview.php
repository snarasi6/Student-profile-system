...
<?php session_start();?>
     ...
     <h1>                   
<form name="assessment" action="adminprint.php" method="post" >
<h3><b>Semester</b></h3>
<input id='inp' type="text" name="semester" placeholder="   " onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   '">
<h3><b>Batch</b></h3>
<input id='inp' type="text" name="batch" placeholder="   " onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   '">
<h3><b>Subject Code</b></h3>
<input id='inp' type="text" name="subcode" placeholder="   " onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   '"><br><br>
