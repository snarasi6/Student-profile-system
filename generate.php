...
<form name="timetable" action="tim.php" method="post" >
<h3><b>Semester</b></h3>
<input id='inp' type="text" name="sem" >
<h3><b>Year</b></h3>
<input id='inp' type="text" name="year" >
<br><br><input  type="submit"  onclick="check(this.form)" value="Go" id='i'/><br>
