                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li >
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="adminenterview.php">View</a>
                            </li>
                         </ul>
                    </li>
                    <li class="active">
...
<form name="assess_enter" action="adminentermark.php" method="post" >
<h3><b>Year</b></h3>
<input id='inp' type="text" name="year" placeholder="   Year" onfocus="this.placeholder = ''" onfocusout="this.placeholder = '  Year'">

<h3><b>Semester</b></h3>
<input id='inp' type="text" name="semester" placeholder="   Semester" onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   Semester'">
<h3><b>Batch</b></h3>
<input id='inp' type="text" name="batch" placeholder="   Batch" onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   Batch'">
<h3><b>Subject Code</b></h3>
<input id='inp' type="text" name="subcode" placeholder="   Sub Code" onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   Sub Code'"><br><br>
<h3><b>Assessment :</b></h3>
<input id='inp' type="text" name="assessment" placeholder="   Assessment" onfocus="this.placeholder = ''" onfocusout="this.placeholder = '   Assessment'"><br><br>
<input  type="submit"  onclick="check(this.form)" value="Go" id='i'/><br>
