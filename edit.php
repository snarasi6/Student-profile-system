...
<!--    -->
<h3><b>Name</b></h3><br>
<form name="edit" action="editdb.php" method="post" >
 <p id='head1'><input type="text" name="name"  /></p>
            <input type="submit"  onclick="check(this.form)" name="action" value="Name" id='b'/>
           <br>
<h3><b>Age</b></h3><br>
<p id='head1'><input type="text" name="age" /><br></p><br>
            <input type="submit"  onclick="check(this.form)" name="action" value="Age" id='b'/>
 <h3><b>Address</b></h3><br>
 <p id='head1'><input type="text" name="address"  /></p>
            <input type="submit"  onclick="check(this.form)" name="action" value="Address" id='b'/>
           <br>
 ...
 <p id='head1'><input type="text" name="phone"  /></p>
           ...
           <br>
            <h3><b>Password</b></h3><br>
 <p id='head1'><input type="text" name="password"  /></p>
            <input type="submit"  onclick="check(this.form)" name="action" value="Password" id='b'/>
           <br>
</form>
