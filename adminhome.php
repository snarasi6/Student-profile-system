                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Student Profile<br><br>
<form name="assess" action="regcheck.php" method="post" >
<h3><b>Register Number</b></h3><br>
<input id='inp' type="text" name="reg_no" placeholder="Register Number" onfocus="this.placeholder = ''" onfocusout="this.placeholder = 'Register Number'">
